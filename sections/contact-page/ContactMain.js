...
const ContactMain = () => {
  return (
  <div className="min-h-screen relative bg-gradient-to-t from-tertiary via-tertiary/70 to-transparent absolute inset-0 py-10">
  <ContainerWrapper className="mt-10 mb-18 backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl p-2 lg:p-7 rounded-xl z-10 relative">
    <div className="grid grid-cols-1 md:grid-cols-[40%_58%] gap-8 items-stretch h-auto md:min-h-[55vh] lg:min-h-[75vh]">
      <div className="backdrop-blur-md bg-white  rounded-2xl shadow-xl p-4 lg:p-8 flex flex-col justify-between relative overflow-hidden">
        <div className="">
      ...
      <div className="backdrop-blur-md bg-white rounded-2xl shadow-xl p-4 lg:p-8">
        <ContactForm />
      </div>
    </div>
  </ContainerWrapper>
